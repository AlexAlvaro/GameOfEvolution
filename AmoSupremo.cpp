...
class CopyCat : public Character
{
  public:
    ...
    void interactua()
    {
        cout <<"Soy CopyCat mi Personalidad es :"<<endl<< "Se adapta al contendiente" << endl;
    }
...
class Cooperative : public Character
{
  public:
    ...
    void interactua()
    {
        cout << "Soy Cooperative mi Personalidad es :"<<endl<<"Sempre Colaboro" << endl;
    }
...
int main()
{
    ...
    Considerado objCoop(20, 1); // Funciona //
